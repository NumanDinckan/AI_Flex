...
- shifted load is recovered in scenario-specific off-peak recipient windows: `22:00-06:00` for `10%` flex and `20:00-08:00` for `25%` flex.
- source intervals are selected by load magnitude and surplus above the annual mean-day reference; price is deliberately excluded from RQ2 flexibility.
